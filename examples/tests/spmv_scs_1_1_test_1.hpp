...
REGISTER_TEST(spmv_scs_1_1_test_1) {
    ...
    SCSMatrix<IT, VT> *A_scs = new SCSMatrix<IT, VT>(1, 1);
    ...
    SCSMatrix<IT, VT> *A_scs_exp = new SCSMatrix<IT, VT>(1, 1);
    A_scs_exp->n_rows = 3;
    ...
    A_scs_exp->nnz = 5;
    A_scs_exp->chunk_ptr = new IT[A_scs_exp->n_chunks + 1]{0, 2, 3, 5};
    A_scs_exp->chunk_lengths = new IT[A_scs_exp->n_chunks]{2, 1, 2};
