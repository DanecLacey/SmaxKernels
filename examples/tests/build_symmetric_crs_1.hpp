...
REGISTER_TEST(build_symmetric_crs_1) {
    ...
    CRSMatrix<IT, VT> *A_sym_exp =
        new CRSMatrix<IT, VT>(A_sym->n_rows, A_sym->n_rows, 24);
    A_sym_exp->col = new IT[A_sym_exp->nnz]{0, 1, 5, 0, 1, 2, 3, 4, 1, 2, 7, 1,
                                            3, 4, 7, 1, 3, 4, 0, 5, 6, 2, 3, 7};
    A_sym_exp->row_ptr =
        new IT[A_sym->n_rows + 1]{0, 3, 8, 11, 15, 18, 20, 21, 24};
