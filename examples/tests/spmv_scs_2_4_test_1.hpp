...
REGISTER_TEST(spmv_scs_2_4_test_1) {
    ...
    int A_scs_n_elements_expected = 6;
    int A_scs_nnz_expected = 5;
    IT *A_scs_chunk_ptr_expected = new IT[A_scs_n_chunks_expected + 1]{0, 4, 6};
    IT *A_scs_chunk_lengths_expected = new IT[A_scs_n_chunks_expected]{2, 1};
