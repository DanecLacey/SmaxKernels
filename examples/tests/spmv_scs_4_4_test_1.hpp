...
REGISTER_TEST(spmv_scs_4_4_test_1) {
    ...
    SCSMatrix<IT, VT> *A_scs = new SCSMatrix<IT, VT>(4, 4);
    ...
    SCSMatrix<IT, VT> *A_scs_exp = new SCSMatrix<IT, VT>(4, 4);
    A_scs_exp->n_rows = 3;
    ...
    A_scs_exp->val = new VT[A_scs_exp->n_elements]{
        1.1, 3.1, 2.2, 0.0, 1.2, 3.3, 0.0, 0.0,
    };
    A_scs_exp->perm = new IT[A_scs_exp->n_rows]{0, 2, 1};
