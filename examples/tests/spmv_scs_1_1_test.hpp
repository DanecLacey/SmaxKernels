...
REGISTER_TEST(spmv_scs_1_1_test) {
    ...
    int A_scs_n_rows_padded_expected = 3;
    int A_scs_n_cols_expected = 3;
    int A_scs_n_chunks_expected = 3;
    int A_scs_n_elements_expected = 5;
    int A_scs_nnz_expected = 5;
    IT *A_scs_chunk_ptr_expected =
        new IT[A_scs_n_chunks_expected + 1]{0, 2, 3, 5};
    IT *A_scs_chunk_lengths_expected = new IT[A_scs_n_chunks_expected]{2, 1, 2};
    IT *A_scs_col_expected = new IT[A_scs_nnz_expected]{0, 1, 1, 0, 2};
    VT *A_scs_val_expected =
        new VT[A_scs_nnz_expected]{1.1, 1.2, 2.2, 3.1, 3.3};
