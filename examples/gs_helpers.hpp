...
#define GS_OUTPUT_FILENAME "compare_gs.txt"
...
class GSParser : public CliParser {
  public:
    struct GSArgs : public CliArgs {
        // No extra fields
    };
    ...
    GSArgs *parse(int argc, char *argv[]) override {
        ...
        delete args_;
        auto *gs_args = new GSArgs();
        gs_args->matrix_file_name = argv[1];
        args_ = gs_args;
        return gs_args;
    }
