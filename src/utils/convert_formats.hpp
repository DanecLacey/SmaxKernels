...
void Utils::convert_coo_to_scs(int A_coo_n_rows, int A_coo_n_cols,
                               int A_coo_nnz, IT *A_coo_col, IT *A_coo_row,
                               VT *A_coo_val, int A_scs_C, int A_scs_sigma,
                               int A_scs_n_rows, int A_scs_n_rows_padded,
                               int A_scs_n_cols, int A_scs_n_chunks,
                               int A_scs_n_elements, int A_scs_nnz,
                               IT *A_scs_chunk_ptrs, IT *A_scs_chunk_lengths,
