...
void Utils::generate_perm(int A_n_rows, IT *A_row_ptr, IT *A_col, int *perm,
    ...
    if ( type == "JH" ){
        ...
        n_levels = Utils::generate_color_perm(A_n_rows, A_sym_row_ptr, A_sym_col, perm, inv_perm, lvl);
    }
    else{
...
template <typename IT>
int Utils::generate_color_perm(int A_n_rows, IT *A_sym_row_ptr, IT *A_sym_col, int *perm,
                          int *inv_perm, int *lvl) {
