...
template <typename IT, typename VT> struct SPGEMMInit {
    int operator()(SMAX::KernelContext context, SparseMatrix *A,
                   SparseMatrix *B, SparseMatrix *C) {
        return SPGEMM_CPU::spgemm_initialize_cpu_core<IT, VT>(context, A, B, C);
    }
};
...
template <typename IT, typename VT> struct SPGEMMApply {
    int operator()(SMAX::KernelContext context, SparseMatrix *A,
                   SparseMatrix *B, SparseMatrix *C) {
        return SPGEMM_CPU::spgemm_apply_cpu_core<IT, VT>(context, A, B, C);
    }
};
...
template <typename IT, typename VT> struct SPGEMMFinalize {
    int operator()(SMAX::KernelContext context, SparseMatrix *A,
                   SparseMatrix *B, SparseMatrix *C) {
        return SPGEMM_CPU::spgemm_finalize_cpu_core<IT, VT>(context, A, B, C);
    }
};
...
int spgemm_dispatch_cpu(SMAX::KernelContext context, SparseMatrix *A,
                        SparseMatrix *B, SparseMatrix *C) {
...
int spgemm_initialize_cpu(SMAX::KernelContext context, SparseMatrix *A,
                          SparseMatrix *B, SparseMatrix *C) {
    return spgemm_dispatch_cpu<SPGEMMInit>(context, A, B, C);
}
int spgemm_apply_cpu(SMAX::KernelContext context, SparseMatrix *A,
                     SparseMatrix *B, SparseMatrix *C) {
    return spgemm_dispatch_cpu<SPGEMMApply>(context, A, B, C);
}
int spgemm_finalize_cpu(SMAX::KernelContext context, SparseMatrix *A,
                        SparseMatrix *B, SparseMatrix *C) {
