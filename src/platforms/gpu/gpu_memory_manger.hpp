...
struct device_deleter {
    void operator()(void *ptr) { CHECK_DEVICE_ERR(GPU_BACKEND(Free)(ptr)); }
};

struct host_deleter {
    void operator()(void *ptr) { CHECK_DEVICE_ERR(GPU_BACKEND(FreeHost)(ptr)); }
};
...
inline void memcpyD2H(const void *dev_src, void *host_dest, size_t N) {
    CHECK_DEVICE_ERR(GPU_BACKEND(Memcpy)(host_dest, dev_src, N * sizeof(VT),
